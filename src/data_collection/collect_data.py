...
CUISINE_KEYWORDS = {
    ...
    "latin": ["latin","latin american","latin-american", "latino"],
...
EXTENDED_CUISINE_KEYWORDS = {
    ...
    "colombian": ["colombian","arepas","patacones","bandeja paisa"],
    "cuban": ["cuban", "ropa vieja", "picadillo", "pastelito", "croquetas", "maduros", "havana"],
    "filipino": ["filipino", "adobo", "sinigang", "lechon", "kare kare", "sisig", "manila"],
    "fish_and_chips": ["fish & chips","fish and chips","chippy","cod and chips"],
    "gastropub": ["gastropub"],
    "georgian": ["georgian","khachapuri","khinkali","adjara","tbilisi"],
    "german": ["german", "schnitzel", "bratwurst", "pretzel", "bavarian", "biergarten", "wurst", "sauerkraut"],
    "indonesian": ["indonesian","nasi goreng","rendang","sate","bali","jakarta"],
    "israeli": ["israeli","sabich","shakshuka","tel aviv","jerusalem"],
    "jewish_deli": ["deli", "pastrami", "bagel", "knish", "matzo", "kosher", "smoked meat", "corned beef", "lox"],
    ...
    "venezuelan": ["venezuelan","arepas","empanadas","tequeños"],
    "west_african": ["nigerian", "ghanaian", "senegalese", "jollof", "suya", "egusi", "fufu", "waakye", "thieboudienne"],
...
BRAND_KEYWORDS: Dict[str, Dict[str, str]] = {
    ...
    "panera bread": {"category": "bakery", "cuisine": "cafe"},
    "panera": {"category": "bakery", "cuisine": "cafe"},
    "dunkin": {"category": "coffee", "cuisine": "cafe"},
    "dunkin' donuts": {"category": "coffee", "cuisine": "cafe"},
    "chick-fil-a": {"category": "chicken", "cuisine": "american"},
    "chick fil a": {"category": "chicken", "cuisine": "american"},
    "subway": {"category": "sandwich", "cuisine": "american"},
    "mcdonalds": {"category": "burger", "cuisine": "american"},
    "mcdonald's": {"category": "burger", "cuisine": "american"},
    "denny's": {"category": "coffee", "cuisine": "american"},
